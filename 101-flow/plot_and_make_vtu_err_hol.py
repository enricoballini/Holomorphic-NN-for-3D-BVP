...
def add_vel_errors(mesh: utils_postprocess.Mesh) -> utils_postprocess.Mesh:
    """ """

    err_abs = np.loadtxt("./results/err_abs_distribution")
    err_rel = np.loadtxt("./results/err_rel_distribution")

    mesh.node_data["err_abs_distribution_vel"] = err_abs
    mesh.node_data["err_rel_distribution_vel"] = err_rel
...
if __name__ == "__main__":
    ...
    mesh = add_vel_errors(mesh)
    utils_postprocess.save_mesh(mesh, "./results/errors_vel_hol.vtk")
