...
def compute_error(
    ...
    stress_exact = utils_postprocess_pinn.interpolate_node_values_to_tet_centroids(
        mesh, stress_exact_nodes
    )
    displ_exact = utils_postprocess_pinn.interpolate_node_values_to_tet_centroids(
        mesh, displ_exact_nodes
    )
    stress_exact_boundary = (
        utils_postprocess_pinn.interpolate_node_values_to_face_centers(
