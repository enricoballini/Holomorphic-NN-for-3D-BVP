...
def loss_reg(params_list, epoch):
    ...
    return jnp.where(epoch < 1000, 1e-3, 1e-8) * total / n_params
...
def loss_l2(
    ...
    reg = loss_reg(params_list, epoch)
