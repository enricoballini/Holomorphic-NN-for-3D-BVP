...
def add_stresses(mesh: utils_postprocess.Mesh) -> utils_postprocess.Mesh:
    ...
    stress_hol = utils_postprocess._batched_sigma(
        jacobian_field,
        tm_list,
        tm_full_list,
        params_list,
...
def add_tractions(mesh: utils_postprocess.Mesh) -> utils_postprocess.Mesh:
    ...
    jacobian_field = utils_mechanics.define_strain_from_displ()
    stress_hol_faces = utils_postprocess._batched_sigma(
        jacobian_field,
        tm_list,
        tm_full_list,
        params_list,
...
def add_residual(mesh):
    ...
    div_sigma = utils_postprocess._batched_div_sigma(
        tm_grid,
        tm_full_list,
        params_list,
        nn_list,
...
if __name__ == "__main__":
    ...
    utils_postprocess.save_mesh(mesh, "./results/residual_hol.vtk")
